...
Eval framework for testing Bedlam agent behaviors across models and prompt versions.
...
Phase 0 covers narrow behavior evals for the Bedlam heartbeat skill:
