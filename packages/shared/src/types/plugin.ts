...
// ---------------------------------------------------------------------------
// Manifest sub-types — nested declarations within BedlamPluginManifestV1
// ---------------------------------------------------------------------------
...
/**
 * Lower-bound semver requirement for the Bedlam host.
 *
...
export interface BedlamPluginManifestV1 {
   ...
   */
  minimumBedlamVersion?: PluginMinimumHostVersion;
