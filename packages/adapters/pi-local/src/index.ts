...
Use when:
- You want Bedlam to run Pi (the AI coding agent) locally as the agent runtime
...
- Bedlam requires an explicit \`model\` value for \`pi_local\` agents.
- Sessions are stored in ~/.pi/bedlams/ and resumed with --session.
