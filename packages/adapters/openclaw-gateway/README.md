...
This document describes how `@bedlam/adapter-openclaw-gateway` invokes OpenClaw over the Gateway protocol.
...
5. stream `event agent` frames into Bedlam logs/transcript parsing
