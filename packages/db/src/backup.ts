...
function resolveBedlamInstanceId(): string {
  const raw = process.env.BEDLAM_INSTANCE_ID?.trim() || "default";
...
function resolveDefaultConfigPath(): string {
  return path.resolve(resolveBedlamHomeDir(), "instances", resolveBedlamInstanceId(), "config.json");
}
...
function resolveDefaultBackupDir(): string {
  return path.resolve(resolveBedlamHomeDir(), "instances", resolveBedlamInstanceId(), "data", "backups");
}
