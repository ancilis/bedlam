...
const manifest: BedlamPluginManifestV1 = {
  ...
  description: "Reference plugin that demonstrates the current Bedlam plugin API surface, UI surfaces, bridge actions, events, jobs, webhooks, tools, local workspace access, and runtime diagnostics in one place.",
  author: "Bedlam",
  ...
  tools: [
    ...
    },
    {
      ...
      description: "Summarizes the current company using the Bedlam domain APIs.",
      parametersSchema: {
        type: "object",
        properties: {},
      },
