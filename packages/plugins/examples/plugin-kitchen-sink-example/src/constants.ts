import type { PluginLauncherRegistration } from "@bedlam/plugin-sdk";

export const PLUGIN_ID = "bedlam-kitchen-sink-example";
...
export const DEFAULT_CONFIG = {
  ...
  workspaceScratchFile: ".bedlam-kitchen-sink-demo.txt",
} as const;
