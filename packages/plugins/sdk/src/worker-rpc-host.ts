...
import type { BedlamPlugin } from "./define-plugin.js";
import type {
 ...
 * import { startWorkerRpcHost } from "@bedlam/plugin-sdk";
 *
 * startWorkerRpcHost({ plugin });
 * ```
 *
...
export function startWorkerRpcHost(options: WorkerRpcHostOptions): WorkerRpcHost {
  ...
  let manifest: BedlamPluginManifestV1 | null = null;
  ...
  const toolHandlers = new Map<string, {
    declaration: Pick<import("@bedlam/shared").PluginToolDeclaration, "displayName" | "description" | "parametersSchema">;
