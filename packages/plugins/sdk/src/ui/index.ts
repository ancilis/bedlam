/**
 * `@bedlam/plugin-sdk/ui` — Bedlam plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@bedlam/plugin-sdk` (root).
 *
 ...
 * import type { PluginWidgetProps } from "@bedlam/plugin-sdk/ui";
 *
