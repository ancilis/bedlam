 ...
 *
 * These components are exported from `@bedlam/plugin-sdk/ui` and are
 ...
 *
 * @see PLUGIN_SPEC.md §19.6 — Shared Components In `@bedlam/plugin-sdk/ui`
 */
...
function createSdkUiComponent<TProps>(name: string): React.ComponentType<TProps> {
  return function BedlamSdkUiComponent(props: TProps) {
