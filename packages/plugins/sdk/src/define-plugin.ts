/**
 * `definePlugin` — the top-level helper for authoring a Bedlam plugin.
 *
...
// ---------------------------------------------------------------------------
// BedlamPlugin — the sealed object returned by definePlugin()
// ---------------------------------------------------------------------------
 ...
 * @returns A sealed `BedlamPlugin` object for the host to consume
 *
 * @example
 * ```ts
 * import { definePlugin } from "@bedlam/plugin-sdk";
