...
This is intentionally separate from the normal Bedlam dev image.
...
```sh
review-checkout-pr bedlam/bedlam 432
cd /work/checkouts/bedlam-bedlam/pr-432
```
...
## Preview the Bedlam app from the PR
...
- Bedlam's embedded PostgreSQL and local storage stay inside the container home volume via `BEDLAM_HOME=/home/reviewer/.bedlam-review`.
