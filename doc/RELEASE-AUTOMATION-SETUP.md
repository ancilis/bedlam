...
This document covers the GitHub and npm setup required for the current Bedlam release model:
...
Do this for every public package that Bedlam publishes.
...
3. add a trusted publisher for the GitHub repository `bedlam/bedlam`
...
2. revoke any personal automation token that used to publish Bedlam
