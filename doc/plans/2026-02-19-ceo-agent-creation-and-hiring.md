...
- installed adapter list for this Bedlam instance
...
## 8. New Skill: `bedlam-create-agent`

Create new skill directory:

- `skills/bedlam-create-agent/SKILL.md`
...
Also update `skills/bedlam/SKILL.md` to reference this skill for hiring workflows.
...
- `bedlam-create-agent` skill + docs updates
