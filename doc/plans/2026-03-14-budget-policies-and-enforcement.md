...
Bedlam already treats budgets as a core control-plane responsibility:
...
This plan defines the concrete budgeting model Bedlam should implement next.

## Product Goals

Bedlam should let operators:
...
For the next implementation pass, Bedlam should enforce these defaults:
...
Bedlam should separate subscription-included usage from billed spend:
...
Bedlam should have two threshold classes:
...
Bedlam must know that a project is budget-paused and enforce it.
...
Bedlam must also block execution before new work starts.
