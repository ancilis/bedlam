 ...
 */
import type { CompanyPortabilityManifest } from "@bedlam/shared";
...
export function generateReadme(
  ...
  lines.push("");
  lines.push("> This is an [Agent Company](https://agentcompanies.io) package from [Bedlam](https://bedlam.ing)");
  lines.push("");
