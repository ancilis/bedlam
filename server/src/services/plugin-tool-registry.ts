...
import type { ToolRunContext, ToolResult, ExecuteToolParams } from "@bedlam/plugin-sdk";
...
export interface PluginToolRegistry {
   ...
   */
  registerPlugin(pluginId: string, manifest: BedlamPluginManifestV1, pluginDbId?: string): void;
