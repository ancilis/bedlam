/**
 * PluginEventBus — typed in-process event bus for the Bedlam plugin system.
 *
 * Responsibilities:
...
import type { PluginEventType } from "@bedlam/shared";
import type { PluginEvent, EventFilter } from "@bedlam/plugin-sdk";
