...
import { models as codexFallbackModels } from "@bedlam/adapter-codex-local";
import { models as cursorFallbackModels } from "@bedlam/adapter-cursor-local";
import { models as opencodeFallbackModels } from "@bedlam/adapter-opencode-local";
import { resetOpenCodeModelsCacheForTests } from "@bedlam/adapter-opencode-local/server";
...
describe("adapter model listing", () => {
  beforeEach(() => {
    ...
    delete process.env.BEDLAM_OPENCODE_COMMAND;
  ...
  it("returns opencode fallback models including gpt-5.4", async () => {
    process.env.BEDLAM_OPENCODE_COMMAND = "__bedlam_missing_opencode_command__";
