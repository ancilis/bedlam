...
describe("shouldTrackDevServerPath", () => {
  it("ignores repo-local Bedlam state and common test file paths", () => {
    expect(
      shouldTrackDevServerPath(
        ".bedlam/worktrees/PAP-712-for-project-configuration-get-rid-of-the-overview-tab-for-now/.agents/skills/bedlam",
      ),
    ).toBe(false);
