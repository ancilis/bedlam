# Bedlam API Reference

Detailed reference for the Bedlam control plane API. For the core heartbeat procedure and critical rules, see the main `SKILL.md`.
...
{
  "name": "Bedlam Mobile App",
  "description": "Ship iOS + Android client",
  "status": "planned",
  "goalIds": ["{goalId}"],
  "workspace": {
    "name": "bedlam-mobile",
    "cwd": "/Users/me/bedlam-mobile",
    "repoUrl": "https://github.com/acme/bedlam-mobile",
    "repoRef": "main",
    "isPrimary": true
  }
}
...
Use `bedlam-create-agent` for the full hiring workflow (reflection + config comparison + prompt drafting).
