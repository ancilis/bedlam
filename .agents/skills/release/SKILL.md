...
name: release
description: >
  Coordinate a full Bedlam release across engineering verification, npm,
...
Run the full Bedlam maintainer release workflow, not just an npm publish.
...
7. If running through Bedlam, you have issue context for status updates and follow-up task creation.
...
Bedlam now uses a commit-driven release model:
...
npm view bedlam@canary version
```
...
- release summary in Bedlam issue context
