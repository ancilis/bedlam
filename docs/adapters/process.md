...
- Running a Python script that calls the Bedlam API
...
1. Bedlam spawns the configured command as a child process
2. Standard Bedlam environment variables are injected (`BEDLAM_AGENT_ID`, `BEDLAM_API_KEY`, etc.)
...
The script can use the injected environment variables to authenticate with the Bedlam API and perform work.
