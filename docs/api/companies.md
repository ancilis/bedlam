...
Manage companies within your Bedlam instance.
...
Company logo uploads use the normal Bedlam attachment size limit.
...
| `logoUrl` | string | Optional Bedlam asset content path for the stored logo image |
