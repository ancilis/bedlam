...
import type { ActivityEvent } from "@bedlam/shared";
import type { Agent, Issue, IssueAttachment, IssueComment } from "@bedlam/shared";
...
export function IssueDetail() {
  ...
  const attachmentUploadButton = (
    <>
      ...
      >
        <Bedlam className="h-3.5 w-3.5 mr-1.5" />
      ...
      <Tabs value={detailTab} onValueChange={setDetailTab} className="space-y-3">
        ...
        <TabsContent value="comments">
          <CommentThread
            ...
            agentMap={agentMap}
            draftKey={`bedlam:issue-comment-draft:${issue.id}`}
            enableReassign
