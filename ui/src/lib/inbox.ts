...
export const DISMISSED_KEY = "bedlam:inbox:dismissed";
export const READ_ITEMS_KEY = "bedlam:inbox:read-items";
export const INBOX_LAST_TAB_KEY = "bedlam:inbox:last-tab";
