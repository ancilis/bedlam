...
export type { TranscriptEntry, StdoutLineParser, CreateConfigValues } from "@bedlam/adapter-utils";
...
export interface UIAdapterModule {
  type: string;
  label: string;
  parseStdoutLine: (line: string, ts: string) => import("@bedlam/adapter-utils").TranscriptEntry[];
