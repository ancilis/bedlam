 ...
 *
 * This is placed on `globalThis.__bedlamPluginBridge__` and consumed by
...
declare global {
  ...
  var __bedlamPluginBridge__: PluginBridgeRegistry | undefined;
}
 ...
 * on `globalThis.__bedlamPluginBridge__` so the plugin module loader
...
export function initPluginBridge(
  ...
  globalThis.__bedlamPluginBridge__ = {
    react,
    reactDom,
    sdkUi: {
      usePluginData,
